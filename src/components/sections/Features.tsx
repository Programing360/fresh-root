...
export default function FeaturedProducts({ products }: FeaturedProductsProps) {
  ...
  return (
    <section className="w-full bg-white dark:bg-neutral-950 px-4 py-16 sm:px-6 lg:px-8">
                        ...
                        <div className="flex items-center gap-1.5">
                          <Link href={`/shop/${product._id}`}>
                            <button
                              ...
                              className="p-2 rounded-full cursor-pointer bg-[#edf4e6] hover:bg-[#558223] text-[#558223] hover:text-white transition-colors duration-200"
                            >
                              <Eye size={13} />
                            </button>
                          </Link>
