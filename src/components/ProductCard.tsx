...
export default function ProductCard({
  ...
  return (
    <motion.div
      ...
      onBlur={onHoverEnd}
      className={`group relative overflow-hidden rounded-2xl border border-neutral-200/70 bg-white p-5 dark:border-neutral-800 dark:bg-neutral-900/60 shadow-sm focus-within:ring-2 focus-within:ring-emerald-500 focus-within:ring-offset-2 outline-none flex transition-all ${
        viewMode === "grid"
    ...
    >
      ...
      >
        ...
        >
          ...
          <Image
            src={product?.image || "https://images.unsplash.com/photo-1542838132-92c53300491e?q=80&w=600"}
        ...
        {viewMode === "grid" ? (
          <button
            ...
            className="mt-4 flex w-full items-center justify-center cursor-pointer gap-2 rounded-full bg-emerald-600 py-2.5 text-xs font-bold tracking-wider text-white shadow-md transition-colors hover:bg-emerald-700"
          >
